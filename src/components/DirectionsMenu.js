	...
	return (
		<div className={styles.directionsMenu}>
			...
			<div className={styles.directionsHorizontalContainer}>
				<button
					id="s9"
					className={`${styles.directionsButton} ${styles.corner1} ${
						currentPanoProps.direction === 's9' ? styles.active : ''
					}`}
					onClick={handleClick}
				/>
				<button
					...
					className={`${styles.directionsButton} ${
						currentPanoProps.direction === 'ww' ? styles.active : ''
					}`}
					onClick={handleClick}
				/>
				<button
					id="s1"
					className={`${styles.directionsButton} ${styles.corner1} ${
						currentPanoProps.direction === 's1' ? styles.active : ''
					}`}
					onClick={handleClick}
				/>
			</div>
			<div className={styles.directionsHorizontalContainer}>
				<button
					id="ss"
					className={`${styles.directionsButton} ${
						currentPanoProps.direction === 'ss' ? styles.active : ''
					}`}
					onClick={handleClick}
				/>
				<button
					id="sc"
					className={`${styles.directionsButton} ${styles.center} ${
						currentPanoProps.direction === 'sc' ? styles.active : ''
					}`}
					onClick={handleClick}
				/>
				<button
					id="nn"
					className={`${styles.directionsButton} ${
						currentPanoProps.direction === 'nn' ? styles.active : ''
					}`}
					onClick={handleClick}
				/>
			</div>
			<div className={styles.directionsHorizontalContainer}>
				<button
					id="s6"
					className={`${styles.directionsButton} ${styles.corner2} ${
						currentPanoProps.direction === 's6' ? styles.active : ''
					}`}
					onClick={handleClick}
				/>
				<button
					id="ee"
					className={`${styles.directionsButton} ${
						currentPanoProps.direction === 'ee' ? styles.active : ''
					}`}
				/>
				<button
					id="s4"
					className={`${styles.directionsButton} ${styles.corner2} ${
						currentPanoProps.direction === 's4' ? styles.active : ''
					}`}
					onClick={handleClick}
				/>
			</div>
